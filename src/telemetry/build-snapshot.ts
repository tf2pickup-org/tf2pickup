...
export async function buildSnapshot() {
  const [
    ...
    configuration.get('queue.captain_min_games'),
    configuration.get('queue.captain_pick_timeout'),
  ...
  const featureEntries = [
    ...
    { key: 'queue.mode', value: queueMode, label: 'Queue mode', group: 'Queue' },
    {
      key: 'queue.captain_min_games',
      value: captainMinGames,
      label: 'Captain minimum games',
      group: 'Queue',
    },
    {
      key: 'queue.captain_pick_timeout',
      value: captainPickTimeout,
      label: 'Captain pick timeout',
      group: 'Queue',
    },
    {
