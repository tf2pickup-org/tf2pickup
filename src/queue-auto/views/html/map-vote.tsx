...
export async function MapVote(props: { gamemode: Gamemode; actor?: SteamId64 | undefined }) {
  const mapOptions = await collections.queueMapOptions.find({ gamemode: props.gamemode }).toArray()
  const results = await getMapVoteResults(props.gamemode)
