...
export async function kick(...steamIds: SteamId64[]): Promise<QueuePlayerModel[]> {
  return await withQueueLock('captain.kick', async () => {
    logger.trace({ steamIds }, 'queue-captain.kick()')
