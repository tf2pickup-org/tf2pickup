...
import { ReadyUpDialog } from '../queues/auto/views/html/ready-up-dialog'
...
export async function Layout(
  ...
  return (
    <html lang="en">
      ...
      <body
        hx-ext="ws,head-support,remove-me,preload,notifications,play-sound,copy-to-clipboard,sync-attribute,countdown,animate-number"
        ws-connect="/ws"
        class="h-screen"
        hx-boost="true"
      >
